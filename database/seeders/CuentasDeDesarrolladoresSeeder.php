...
class CuentasDeDesarrolladoresSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Http::post('http://localhost:8000/auth/activarDocente',[
            "cod_SIS" => "12345001",
            "nombre" => "FERNANDO CUENCA VARGAS",
            "celular" => "7123456",
        ...
        Http::put('http://localhost:8000/admin/validarCuenta/'.$idDocente);


        Http::post('http://localhost:8000/auth/crearAdmin',[
            "cod_SIS" => "12346001",
            "nombre" => "FERNANDO CUENCA VARGAS",
